...
/// </summary>
internal sealed class SetConditionAction(SampleIntegration integration) : IActionDefinition, IDynamicOptionsActionDefinition
{
	...
	public Task<DynamicOptionsResult> GetDynamicOptionsAsync(DynamicOptionsContext context, CancellationToken cancellationToken)
		=> Task.FromResult(new DynamicOptionsResult
		{
			Options =
			[
				.. SampleIntegration.SelectableConditions
